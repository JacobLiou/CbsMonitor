    ...
    public partial class CBSParamControl : UserControl
    {
        ...
        private void btnWrite_Click(object sender, EventArgs e)
        {
            ...
            if (!CheckTextBoxRange(txt_1, 0, 4000, "单体过充保护") || !CheckTextBoxRange(txt_2, 0, 3800, "单体过充解除") || !CheckTextBoxRange(txt_3, 0, 3800, "单体过充告警") ||
                ...
                !CheckTextBoxRange(txt_40, -40, 125, "放电低温解除") ||
                ...
                !CheckTextBoxRange(txt_58, 0, 60.8, "电池包截止电压") || !CheckTextBoxRange(txt_59, 0, 655.35, "电池包截止电流"))
            {
                return;// 范围检查失败
            }*/
            if (false)
                ...
                for (int i = 1; i <= num; i++)
                {
                    ...
                    if (((CheckBox)c).Checked)
                    {
                        switch (c.Name)
                        {
                            ...
                            case "ckb_14":
                                canid[2] = 0x1B;
                                bytes = Uint16ToBytes(txt_64, txt_65, txt_66, txt_67, 0.01, 0.01, 0.01, 0.01);
                                break;
                            case "ckb_15":
                                canid[2] = 0x1C;
                                bytes = Uint16ToBytes(txt_68, txt_69, txt_70, txt_71, 1, 1, 1, 1);
                                break;
                        }
        ...
        public void analysisData(uint canID, byte[] data)
        {
            ...
            switch (canid[2])
            {
                ...
                case 0x22://电池包
                    ...
                    break;
                case 0x1B://MOS
                    txt_64.Text = (numbers[0] * 0.01).ToString();
                    txt_65.Text = (numbers[1] * 0.01).ToString();
                    txt_66.Text = (numbers[2] * 0.01).ToString();
                    txt_67.Text = (numbers[3] * 0.01).ToString();
                    break;
                case 0x1C://MOS
                    txt_68.Text = numbers[0].ToString();
                    txt_69.Text = numbers[1].ToString();
                    txt_70.Text = numbers[2].ToString();
                    txt_71.Text = numbers[3].ToString();
                    break;
            }
        }
